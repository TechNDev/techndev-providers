#!/usr/bin/env python3
"""
techndev-providers  ebay/_auth.py  v1.0.0
==========================================
eBay OAuth 2.0 Application Token (Client Credentials Flow).
Thread-safe Token-Cache: ein Token pro (client_id, scope)-Paar.
